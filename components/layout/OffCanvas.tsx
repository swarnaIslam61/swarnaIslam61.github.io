					...
					<div className="offCanvas__side-info mb-30">
						<div className="contact-list mb-30">
							...
							<div className="mb-3">
								...
								<p className="mb-0">+8801865520922</p>
							</div>
							<div className="mb-3">
								<span className="text-400 fs-5">Email</span>
								<p className="mb-0">swarnaislam2000@gmail.com</p>
							</div>
							<div className="mb-3">
								<span className="text-400 fs-5">Skype</span>
								<p className="mb-0">Mansura Islam Swarna</p>
							</div>
							<div className="mb-3">
								<span className="text-400 fs-5">Address</span>
								<p className="mb-0">58/36/3-A Mugdha, Madinabag, Dhaka1214</p>
							</div>
						</div>
						<div className="contact-list">
							<p className="text-400 fs-5 mb-2">Social</p>
							<div className="d-md-flex d-none gap-3">
								<Link href="https://www.facebook.com/profile.php?id=100081044210244">
									<i className="ri-facebook-circle-fill fs-18" />
								</Link>
								<Link href="https://x.com/SwarnaIslam61?t=KIgf979rklVIBeYrQ-Wdvw&s=08">
									<i className="ri-twitter-x-fill fs-18" />
								</Link>
								<Link href="https://www.linkedin.com/in/mansuraislamswarna/">
									<i className="ri-linkedin-fill fs-18" />
								</Link>
								<Link href="https://github.com/swarnaIslam61">
