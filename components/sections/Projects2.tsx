										...
										<div className="swiper-wrapper">
												...
												<div className="p-lg-5 p-md-4 p-3 border border-1 mt-5 bg-3">
													<div className="row">
														<div className="col-lg-5">
															<img className="w-100" src="assets/projectsM/dodo.jpg" alt="zelio" />
														</div>
														<div className="col-lg-7 ps-lg-5 mt-5 mt-lg-0">
															...
															<p>Led testing and validation efforts to optimize application functionality and reliability.</p>
															<ul className="mt-4 list-unstyled">
																...
																<li className="text-dark mb-3 border-bottom pb-3">
																	<div className="d-flex justify-content-between">
																		...
																		<p className="text-300 mb-0 text-end">about 1 year</p>
																	</div>
																</li>
																<li className="text-dark mb-3 border-bottom pb-3">
																	<div className="d-flex justify-content-between">
															...
															<div className="d-flex flex-wrap align-items-center gap-3 mt-7">
																<Link href="https://dodobazar.com/common/post-ad" className="text-300 border-bottom border-1 px-2 pb-2 link-hover">
																...
																<Link href="https://github.com/swarnaIslam61" className="text-300 border-bottom border-1 px-2 pb-2 link-hover">
											...
											<SwiperSlide>
												<div className="p-lg-5 p-md-4 p-3 border border-1 mt-5 bg-3">
													<div className="row">
														<div className="col-lg-5">
															<img className="w-100" src="assets/projectsM/eShikhon.jpg" alt="zelio" />
														</div>
														<div className="col-lg-7 ps-lg-5 mt-5 mt-lg-0">
															<h4 className="text-linear-4">
																eShikhon.com <br />
															...
															<div className="d-flex flex-wrap align-items-center gap-3 mt-7">
																<Link href="https://www.eshikhon.site/login" className="text-300 border-bottom border-1 px-2 pb-2 link-hover">
																	<svg xmlns="http://www.w3.org/2000/svg" width={13} height={13} viewBox="0 0 13 13" fill="none">
																		<path d="M11.0037 3.91421L2.39712 12.5208L0.98291 11.1066L9.5895 2.5H2.00373V0.5H13.0037V11.5H11.0037V3.91421Z" fill="#8F8F92" />
																	</svg>
																	Live Demo
