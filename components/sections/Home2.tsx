							...
							<div className="row align-items-end py-60">
								...
								<div className="col-lg-6 mx-lg-auto col-md-12">
									<div className="p-lg-0 p-md-8 p-3">
										<div className="text-secondary-2 d-flex align-items-center">
											...
											<div className="text-dark">
												<div className="typewriter">
													<h1 className="fs-6 fw-medium">Hey, I’m Mansura Islam Swarna</h1>
												</div>
											</div>
											&lt;/span&gt;
										</div>
										...
										<p className="mb-6 text-secondary-2">&lt;p&gt;<span className="text-dark">With expertise in manual and automated testing using tools like </span> <span className="text-secondary-2">JMeter</span>, <span className="text-secondary-2">Postman</span>, <span className="text-secondary-2">Selenium</span><span className="text-dark">... I ensure software quality and reliabilityas.  I deliver thorough testing solutions that guarantee robust, user-centered applications.</span>&lt;/p&gt;</p>
										<div className="row">
											<div className="col-7">
												{/* Carausel Scroll */}
