							...
							<div className="p-lg-8 p-md-6 p-3 position-relative z-1">
								...
								<div className="row mt-5">
									...
									<div className="col-lg-8 ps-lg-5 mt-5 mt-lg-0">
										...
										<ul className="mt-4"> 
											<li className="text-white mb-3"> <span style={{ color: "white" }}>Ensured the</span> <span className="text-secondary-2">quality and performance</span> <span style={{ color: "white" }}> of scalable web applications, enhancing the user experience for millions of users.</span> </li>
											<li className="text-white mb-3"> <span style={{ color: "white" }}>Led testing and validation efforts to optimize application functionality and reliability.</span></li>
											<li className="text-white mb-3"> <span style={{ color: "white" }}>Led testing and validation efforts to optimize application functionality and reliability.</span></li>
										</ul>
