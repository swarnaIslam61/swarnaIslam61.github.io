							...
							<div className="p-lg-8 p-md-6 p-3 position-relative z-1">
								...
								<div className="row mt-5">
									...
									<div className="col-lg-8 ps-lg-5 mt-5 mt-lg-0">
										...
										<ul className="mt-4">
											<li className="text-dark mb-3">Ensured the  <span className="text-secondary-2">quality and performance</span> of scalable web applications, enhancing the user experience for millions of users.</li>
